...
import com.ihsan.simlab.databinding.ActivityBerandaBinding;
...
public class BerandaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarBeranda.fab.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_beranda);
